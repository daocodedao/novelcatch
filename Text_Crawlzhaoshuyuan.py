...
def catchList(url):
    ...
    listChapter = html.xpath('//*[@id="chapterList"]/li')
    ...
    for chapter in listChapter:
        try:
            ...
            cha["chapterUrl"] = f"https://www.zhaoshuyuan.com{chapter.xpath('./a/@href')[0]}"
            chapterInfoList.insert(0, cha.copy())
...
def catchNovel(url):
    ...
    contents = html.xpath('//*[@id="contentbox"]/p/text()')
    return contents
...
{
    "url":"",
    "listUrl":"https://www.zhaoshuyuan.com/b/240084/#gsc.tab=0",
    "bookTitle":"重生印度当首富",
    "mode":"new"
},
